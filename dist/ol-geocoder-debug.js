 ...
 * Built: Mon Mar 04 2019 13:58:28 GMT+0100 (Mitteleuropäische Normalzeit)
 */
...
(function (global, factory) {
  ...
  GeoCodr.prototype.handlePagingResponse = function handlePagingResponse (res) {
  ...
  Nominatim.prototype.query = function query (q, offsetOption) {
      var this$1 = this;
      ...
      .then(function (res) {
        ...
        switch (this$1.options.provider) {
          ...
          case PROVIDERS.GEOCODR:
            res_ = res.features.length
              ? this$1.GeoCodr.handleResponse(res.features)
              : undefined;
            pag_ = res.features.length
              ? this$1.GeoCodr.handlePagingResponse(res.properties)
              : undefined;
            break;
          default:
  ...
  Nominatim.prototype.createPaging = function createPaging (response) {
      var this$1 = this;
    ...
    if (offset >= 0) {
      spanLeft.addEventListener(
        ...
        function (evt) {
          evt.preventDefault();
          let offsetOption = response.offset - this$1.options.limit;
          this$1.query(this$1.lastQuery, offsetOption);
        },
        false
      );
